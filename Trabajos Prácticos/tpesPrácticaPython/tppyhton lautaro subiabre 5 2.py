...
print("3- imprimir ub calculo matematico en python")
...
print("2:Desarrollo de aplicaciones web con frameworks como Django o Flask. Automatización de tareas y procesamiento de datos.")
