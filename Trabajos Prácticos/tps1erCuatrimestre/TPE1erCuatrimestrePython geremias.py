...
if numero1%2==0 and numero1%3==0:
     print(f"El numero {numero1} es divisible por 2 y por 3")
else:
     print(f"El numero {numero1} no es divisible por 2 y por 3")
'''
...
'''
   ...
   '''
print(f"El numero mayor es {lista_numero[2]} y el numero menor {lista_numero[9]}")
'''
